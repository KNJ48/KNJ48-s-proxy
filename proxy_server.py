...
<script>
(function () {
    console.log("Lv6 Step1 Hook Loaded");
    ...
    function proxyRelative(url) {
        ...
        try {
            ...
            const proxied = "/proxy?url=" + encodeURIComponent(full);

            console.log("[RELATIVE]", url, "=>", proxied);
    ...
    try:
        ...
        if "text/html" in content_type:
            ...
            if "</head>" in html:
                ...
                print("Step1 hook injected into <head>")
            elif "<body>" in html:
                html = html.replace("<body>", "<body>" + HOOK_SCRIPT, 1)
                print("Step1 hook injected into <body>")
            else:
                html = HOOK_SCRIPT + html
                print("Step1 hook prepended")
